...
## Changes performed in Hyperparameters:
# RPN.ANCHOR_SIZE
# FPN.ANCHOR_STRIDE
# FPN.NORM
# FPN.BOXCLASS_HEAD_FUNC
# FPN.MRCNN_HEAD_FUNC
...
_C.RPN.ANCHOR_SIZES = (2, 8, 32, 64, 128)#(32, 64, 128, 256, 512)# (8, 64, 128, 256, 1024) #wienerberger   # sqrtarea of the anchor box, default (32, 64, 128, 256, 512)
...
# FPN -------------------------
_C.FPN.ANCHOR_STRIDES =  (4, 8, 16, 32, 64) #wienerberger # (1, 1, 2, 2, 4, 8, 16, 32, 64)  # strides for each FPN level. Must be the same length as ANCHOR_SIZES default (4, 8, 16, 32, 64)
