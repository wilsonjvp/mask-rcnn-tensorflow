...
_C.RPN.ANCHOR_SIZES = (8, 64, 128, 256, 512, 1024) #(2, 4, 8, 16, 32, 64, 128, 256, 512)   # sqrtarea of the anchor box, default (32, 64, 128, 256, 512)
...
# FPN -------------------------
_C.FPN.ANCHOR_STRIDES = (4, 8, 16, 32, 64, 64)# (1, 1, 2, 2, 4, 8, 16, 32, 64)  # strides for each FPN level. Must be the same length as ANCHOR_SIZES default (4, 8, 16, 32, 64)
